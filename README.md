...
6. To run video: Type `python Video_test2.py` --> The video will be displayed --> All valid and suitable generated results will be displayed and counted using probability.
